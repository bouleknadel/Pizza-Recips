...
import com.example.pizzarecips.adapter.PizzaAdapter;
import com.example.pizzarecips.classes.Produit;
import com.example.pizzarecips.service.ProduitService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(ListPizzaActivity.this,PizzaDetails.class);
                Produit produit = ps.findAll().get(position);
                ...
                i.putExtra("detailsIngred", detailsIngred);
